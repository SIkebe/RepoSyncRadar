...
- `GitHub.Copilot.SDK` 1.0.7-preview.0 nupkg includes `build/GitHub.Copilot.SDK.props` with `CopilotCliVersion=1.0.70-0`; do not pin `CopilotCliVersion` in `Directory.Build.props` unless a future package regresses.
